...
class CustomSMAABlendingWeightCalculationShader : public Shader
{
   public:
...
class CustomSMAANeighborhoodBlendingShader : public Shader
{
   public:
...
class CustomSMAA
{
   public:
    ...
    CustomSMAA(int w, int h);
    void loadShader(CustomSMAA::Quality _quality);
   ...
   private:
    ...
    std::shared_ptr<CustomSMAABlendingWeightCalculationShader> smaaBlendingWeightCalculationShader;
    std::shared_ptr<CustomSMAANeighborhoodBlendingShader> smaaNeighborhoodBlendingShader;
